      ...
      <section className="wrapper style5">
        ...
        <div className="inner">
          ...
          <Fade right >
            ...
            <h5>~ GatsbyJS site full of images, a Contact Form and custom color theme ~</h5>
          </Fade>
          ...
          <Fade right >
            ...
            <h5>~ GatsbyJS and CMS site using GraphQL ~</h5>
          </Fade>
          ...
          <Fade left>
            ...
            <h5>~ Sign up form that is easily customized to your brand and implemented ~</h5>
          </Fade>
          <hr />
          <Fade right >
            <h4>WWC Returnship</h4>
            <p><span className="image right">
            ...
            <h5>~ GatsbyJS and NetlifyCMS site ~</h5>
          </Fade>
          <hr />
          <Fade left>
            <h4>First Site</h4>
